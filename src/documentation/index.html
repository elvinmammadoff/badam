...
<head>
  ...
  <!-- Title -->
  <title>Badam - Digital Agency Bootstrap Template Documentation</title>
    ...
    <div id="container" class="row">
      ...
      <div id="main-content" class="large-9 columns">
        ...
        <section id="read-first">
          <div class="row">
            <div class="large-centered columns">
              <div class="name">
                <h3>Badam - Digital Agency Bootstrap Template <span>v1.0</span></h3>
              ...
              <p>Thank you for purchasing <code>Badam</code> Digital Agency Bootstrap Template. <br> You can find the detailed information about the template in this document. <br> If you have any questions that are beyond the scope of this help
        ...
        <section id="introduction" class="section">
          ...
          <p class="lead">You are a shining owner of a regular license based on Digital Agency Responsive Bootstrap Template.
          </p>
          <p>We would like to thank you for choosing <code>Badam</code> Digital Agency Bootstrap Template and for being our loyal customer.
        ...
        <section id="credits" class="section">
          ...
          <ul class="credits">
            <li>
              <a href="https://getbootstrap.com/docs/3.4/getting-started/" target="_blank" class="fs-1_4 bold">
                Bootstrap v3.4
              </a>
            </li>
            <li>
              <span class="d-block"><strong>Fonts</strong></span>
              <a href="https://fonts.google.com/specimen/Raleway" rel="nofollow" target="_blank">Raleway</a>
              <a href="https://www.dafont.com/bignoodletitling.font" rel="nofollow" target="_blank">Big Noodle Titling</a>
            </li>
            <li>
              <span class="d-block"><strong>Icons</strong></span>
              <a href="https://fontawesome.com/v4/get-started/" rel="nofollow" target="_blank">Font Awesome 4.7</a>
            </li>
            <li>
