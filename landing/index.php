    ...
    <div class="banner" id="banner">
        <div class="banner-inner">
            <div class="container">
                ...
                <h1 class="title upper">Badam Digital Agency HTML Template</h1>
                <p class="subtitle">
                    Badam Digital Agency is a suitable fit for all types of agency websites, insurance company, financial consulting and consultant and many more. 
                </p>
                <p class="subtitle">
                    Badam is developer-friendly, fast, lightweight, clean, and contains W3-valid source code. The template is easily customizable and expandable and has detailed documentation. Our quick and friendly support team will gladly assist with the template’s needs.
                </p>
    ...
    <div class="container section" id="pages">
        ...
        <div class="row">
            <div class="col-sm-6 col-md-6 col-lg-6">
                <div class="demo">
                    <a href="https://badamagency.netlify.app/" class="demo-item">
                        <div class="demo-inner page-1"></div>
                    </a>
                    <h4 class="demo-title">Home Version 1</h4>
                    <a href="https://badamagency.netlify.app/" class="button">View Page</a>
                </div>
            </div>
            <div class="col-sm-6 col-md-6 col-lg-6">
                <div class="demo">
                    <a href="https://badamagency.netlify.app/home-v2" class="demo-item">
                        <div class="demo-inner page-2"></div>
                    </a>
                    <h4 class="demo-title">Home Version 2</h4>
                    <a href="https://badamagency.netlify.app/home-v2" class="button">View Page</a>
                </div>
            </div>
        </div>
    </div>
